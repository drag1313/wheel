  ...
  Widget build(BuildContext context) {
    ...
    List<PieChartSectionData> list = [
      PieChartSectionData(
        value: workCounter,
        title: "Работа",
        radius: displayWidth(context) / 2.2 * pieValidate(workCounter),
        color: Colors.redAccent,
      ),
      PieChartSectionData(
        value: moneyCounter,
        title: "Финансы",
        radius: displayWidth(context) / 2.2 * pieValidate(moneyCounter),
        color: Colors.lightGreen,
      ),
      PieChartSectionData(
        value: familyCounter,
        title: "Отношения",
        radius: displayWidth(context) / 2.2 * pieValidate(familyCounter),
        color: Colors.amberAccent,
      ),
      PieChartSectionData(
        value: sportCounter,
        title: "Спорт",
        radius: displayWidth(context) / 2.2 * pieValidate(sportCounter),
        color: Colors.cyanAccent,
      ),
      PieChartSectionData(
        value: healthCounter,
        title: "Здоровье",
        radius: displayWidth(context) / 2.2 * pieValidate(healthCounter),
        color: Colors.deepOrangeAccent,
      ),
      PieChartSectionData(
        value: friendsCounter,
        title: "Друзья",
        radius: displayWidth(context) / 2.2 * pieValidate(friendsCounter),
        color: Colors.lightBlue,
      ),
      PieChartSectionData(
        value: developmentCounter,
        title: "Развитие",
        radius: displayWidth(context) / 2.2 * pieValidate(developmentCounter),
        color: Colors.purple,
      ),
      PieChartSectionData(
        value: hobbyCounter,
        title: "Хобби",
        radius: displayWidth(context) / 2.2 * pieValidate(hobbyCounter),
        color: Colors.pink,
      ),
    ];
